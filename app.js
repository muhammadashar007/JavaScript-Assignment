...
function studentBioDate() {
    var stdName = "Saweira Abdul Rauf";
    var age = "20 years";
    var rollNo = "WM10274";
...
function broswerMessageForClothing() {
    var visitorName = "Yaseera Irfan"
    var productTitle = "Make up"
    var quantity = 5
...
function broswerMessageForIllegal() {
    ...
    var txt = "Hello"
    var ruleVariable = "Rules for naming JS variables"
